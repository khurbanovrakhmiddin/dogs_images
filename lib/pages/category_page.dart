...
import 'package:dogs_images/views/favorite_view.dart';
import 'package:dogs_images/views/vote_view.dart';

class CategoryPage extends StatefulWidget {
  final crossAxisCount;
  const CategoryPage({Key? key, this.crossAxisCount}) : super(key: key);
